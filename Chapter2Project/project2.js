...
let n1 = 3; // create and initialize a number variable with the name n1 using any numeric values desired
let n2 = 9; //create and initialize a number variable with the name n2 using any numeric values desired
...
let myNameMultNum = myName * n1; // create and initialize a variable named myNameMultNum to multiply one of your numeric variables to the string variable
...
let ageCompare = 35 > numberMult; // create and initialize a variable named ageCompare to compare your age (you can use a made-up, but realistic value) 
// to the multiplication of your numeric variables (hint, use <, <=, >, or >= to do a comparison. The comparison will evaluate true or false).
